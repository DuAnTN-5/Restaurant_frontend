...
function Content() {
  ...
  //     imgSrc:
  //       "https://media.istockphoto.com/id/1142230160/vi/anh/%C4%91%E1%BA%A7u-b%E1%BA%BFp-xinh-%C4%91%E1%BA%B9p-l%C3%A0m-vi%E1%BB%87c-trong-nh%C3%A0-b%E1%BA%BFp-t%E1%BA%A1i-nh%C3%A0-h%C3%A0ng.jpg?s=170667a&w=0&k=20&c=uMGut8ZARuOEwwrN31tmcrK4uj8QGRgcSJKUcPkR3KE=", // Replace with actual image path
  //     facebook: "https://facebook.com/chef1",
  //     youtube: "https://youtube.com/chef1",
  //   },
  //   {
  //     name: "Mendia Juxef",
  //     title: "Burger King",
  ...
  //     youtube: "https://youtube.com/chef2",
  //   },
  //   {
  //     name: "Petro William",
  //     title: "Main Chef",
  ...
  //     youtube: "https://youtube.com/chef3",
  //   },
  //   {
  //     name: "Sophia Loren",
  //     title: "Pastry Chef",
  ...
  //     youtube: "https://youtube.com/chef4",
  //   },
  //   {
  //     name: "Luca Ferraro",
  //     title: "Head Chef",
  //     imgSrc:
  //       "https://media.istockphoto.com/id/1142230160/vi/anh/%C4%91%E1%BA%A7u-b%E1%BA%BFp-xinh-%C4%91%E1%BA%B9p-l%C3%A0m-vi%E1%BB%87c-trong-nh%C3%A0-b%E1%BA%BFp-t%E1%BA%A1i-nh%C3%A0-h%C3%A0ng.jpg?s=170667a&w=0&k=20&c=uMGut8ZARuOEwwrN31tmcrK4uj8QGRgcSJKUcPkR3KE=", // Replace with actual image path
  //     facebook: "https://facebook.com/chef5",
  //     youtube: "https://youtube.com/chef5",
  //   },
  // ];
  ...
  return (
    <div className="container mx-auto py-12">
      ...
      <div className="flex items-center justify-center space-x-4">
        ...
        <h1 className="text-5xl font-bold mb-8">Our Specials Menu</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-[1300px] mt-[70px]">
          ...
          <div className="relative border-[1px] rounded-xl overflow-hidden shadow-lg bg-white">
            ...
            <div className="absolute top-[275px] left-2 bg-white rounded-lg px-3 py-1 text-gray-500 flex items-center space-x-2 z-10">
              ...
              <span className="font-bold ml-2">$56.00</span>
            </div>
            <div className="p-4">
              <h1 className="text-xl font-bold mb-2">Shushi</h1>
          ...
          <div className="relative border-[1px] rounded-xl overflow-hidden shadow-lg bg-white">
            <img
              className="w-full h-auto rounded-t-xl"
              src="https://wp.validthemes.net/restan/wp-content/uploads/2024/05/17-1.jpg"
              alt="Salmon Fry"
            />
            <div className="absolute top-[275px] left-2 bg-white rounded-lg px-3 py-1 text-gray-500 flex items-center space-x-2 z-10">
              <CiStar className="text-yellow-500" />
              <span className="font-bold">5.00</span>
              <span className="text-gray-500">(2)</span>
              <span className="font-bold ml-2">$81.00</span>
            </div>
            <div className="p-4">
              <h1 className="text-xl font-bold mb-2">Salmon Fry</h1>
              <ul className="flex space-x-2 text-gray-600">
                <li>4 Chicken Legs</li>
                <li>Chili Sauce</li>
                <li>Soft Drinks</li>
          ...
          <div className="text-center group relative">
            <div className="relative">
              <img
                ...
                alt="Mendia Juxef"
              />
              <div className="flex justify-center text-[30px] items-center space-x-4 opacity-0 group-hover:opacity-100  transform scale-0 group-hover:scale-100 transition-transform duration-[600ms] absolute inset-0 bg-opacity-50 bg-black rounded-full">
